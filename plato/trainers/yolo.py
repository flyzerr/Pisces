...
from packages.yolov5.yolov5.utils.general import (box_iou, check_dataset, one_cycle,
                                  non_max_suppression, scale_coords, xywh2xyxy)
from packages.yolov5.yolov5.utils.loss import ComputeLoss
from packages.yolov5.yolov5.utils.metrics import ap_per_class
...
class Trainer(basic.Trainer):
    ...
    def test_model(self, config, testset):  # pylint: disable=unused-argument
        ...
        # print(pf % ('all', seen, nt.sum(), mp, mr, map50, map))   ############################################## 报错: UnboundLocalError: local variable 'mr' referenced before assignment
